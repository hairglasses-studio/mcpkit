...
- **Multi-agent orchestration** — fan-out, pipeline, select, and swarm mesh patterns (`orchestrator`); manager/agent-as-tool delegation (`handoff`)
...
| `orchestrator` | Multi-agent execution patterns: fan-out, pipeline, select, swarm mesh, stage middleware | none |
