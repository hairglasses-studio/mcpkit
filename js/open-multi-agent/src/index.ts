 ...
 *   name: 'writers',
 *   agents: [
 *     { name: 'researcher', model: 'gpt-5.5', systemPrompt: 'You research topics thoroughly.' },
 *     { name: 'writer',     model: 'gpt-5.5', systemPrompt: 'You write clear documentation.' },
 *   ],
 *   sharedMemory: true,
 * })
