...
## Secrets (1Password — Personal vault, my.1password.com)

| Item Name | Env Var | Field |
|-----------|---------|-------|
| Anthropic API Key (Work - 10K credits) | ANTHROPIC_API_KEY | password |
| AFTRS MCP - mcpkit GitHub PAT | GITHUB_TOKEN / MCPKIT_TOKEN | credential |
| AFTRS MCP - Claude Max Personal API Key | PERSONAL_CLAUDE_MAX_ANTHROPIC_API_KEY | credential |

### Retrieve on WSL/Ubuntu
```bash
