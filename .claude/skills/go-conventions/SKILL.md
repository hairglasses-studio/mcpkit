...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/go-conventions/SKILL.md; DO NOT EDIT -->

Compatibility mirror of the canonical `go-conventions` skill.
